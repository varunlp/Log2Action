...
- Create the first admin with `INITIAL_ADMIN_EMAIL` and `INITIAL_ADMIN_PASSWORD` in your environment, then comment them out or remove them after the admin exists.
